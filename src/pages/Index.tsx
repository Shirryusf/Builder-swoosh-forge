...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-28">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="text-center">
              <div className="font-geist text-74 leading-[89px] font-bold text-stratech-text-blue mb-6">
                95%
              </div>
          ...
          {/* Highlighted Stat */}
          <div className="text-center">
            <div className="font-geist text-[120px] leading-[144px] font-bold text-stratech-blue mb-6">
              99.9%
            </div>
            <p className="font-geist-mono text-20 leading-[27px] text-stratech-blue">
              Uptime Guarantee
            </p>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="py-24 bg-stratech-background border-t border-stratech-text-blue/50">
        <div className="max-w-7xl mx-auto px-28">
          {/* Footer Content */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            ...
            <div>
              <div className="mb-8">
                <div className="text-stratech-blue font-jaldi text-2xl font-bold mb-6">
                  STRATECH
                </div>
              </div>
              <p className="font-geist-mono text-20 leading-[27px] text-stratech-text-blue">
            ...
            {/* Contact Info */}
            <div className="text-center">
              <div className="font-jaldi text-28 leading-[30px] text-stratech-text-blue">
                info@stratech24.com
                <br />
                (+49) 176 72733996
              </div>
